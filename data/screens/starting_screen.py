...
class StartingScreen(tools.GameState):
    ...
    def set_buttons(self):
        start_button = button.Button(
            int(160 * self.multiplier),
            int(870 * self.multiplier),
    ...
    def set_textboxes(self):
        spy1 = text_box.InputBox(220, 435, 500, 100, c.WHITE, 50, "top secret text")
        spy2 = text_box.InputBox(1100, 250, 500, 100, c.WHITE, 50, "top secret text")
        team1_operative1 = text_box.InputBox(220, 555, 500, 100, c.WHITE, 50, "top secret text")
        team2_operative1 = text_box.InputBox(1100, 370, 500, 100, c.WHITE, 50, "top secret text")
        team1_operative2 = text_box.InputBox(220, 675, 500, 100, c.WHITE, 50, "top secret text")
        team2_operative2 = text_box.InputBox(1100, 490, 500, 100, c.WHITE, 50, "top secret text")
